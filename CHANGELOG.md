...
All notable changes to Pro-Prompt follow [Keep a Changelog](https://keepachangelog.com/en/1.1.0/)
...
- `pro-prompt wipe --yes` removes all state and hook blocks.
...
- `@pro-prompt/*` packages are not yet published on npm; installation is
